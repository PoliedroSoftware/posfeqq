    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
         ...
         <a title="Generar Reporte F. Electrónica" href="{{ route('facturacionReportes') }}" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs">
            <strong>Generar Reporte F. Electrónica</strong>
        </a>
        <a title="Facturar Electrónicamente" href="{{ route('facturacion') }}" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default hidden-xs">
            <strong>Facturar Electrónicamente</strong>
        </a>
