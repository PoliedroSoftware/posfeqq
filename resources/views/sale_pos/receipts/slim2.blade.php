    ...
    <body>
        <div class="ticket">
           ...
           <div class="custom-row">
                <div style="text-align: justify; flex: 0 0 40%; max-width: 40%; box-sizing: border-box;">
                          <p >
				...
				@if(!empty($receipt_details->address))
					<b>Dirección: </b>{!! $receipt_details->address !!}
				...
				@if(!empty($receipt_details->website))
					<br><b>Web: </b>{{ $receipt_details->website }}
				@endif
                ...
                <div syle="flex: 0 0  30%; max-width: 30%; box-sizing: border-box; ">
                ...
                <div style=" flex: 0 0 30%;  max-width: 30%; box-sizing: border-box; ">
                                {{-- Barcode --}}
