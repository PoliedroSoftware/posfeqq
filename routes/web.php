...
use App\Http\Controllers\facturacionElectronicaReportesController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
 ...
 Route::get('facturacion', [FacturacionElectronicaController::class, 'index'])->name('facturacion');
    
    Route::get('facturacion/data', [FacturacionElectronicaController::class, 'getFacturas'])->name('facturacion.data');
    
    Route::post('facturacion/enviar/{id}', [FacturacionElectronicaController::class, 'enviarDian'])->name('facturacion.enviar');

    Route::get('facturar', [FacturacionElectronicaReportesController::class, 'index'])->name('facturacionReportes');
